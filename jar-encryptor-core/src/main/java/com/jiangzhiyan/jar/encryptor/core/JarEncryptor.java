...
import com.jiangzhiyan.jar.encryptor.core.util.*;
...
public class JarEncryptor {
    ...
    static {
        ...
        aopMap.put("spring.code", "char[] c=${passchar};"
                + "is=com.jiangzhiyan.jar.encryptor.core.JarDecryptor.getInstance().decryptConfigFile(this.path,is,c);");
        ...
        aopMap.put("jfinal.code", "char[] c=${passchar};inputStream=com.jiangzhiyan.jar.encryptor.core.JarDecryptor.getInstance().decryptConfigFile(fileName,inputStream,c);");
...
//        });
    ...
    private void encryptConfigFile() {
        ...
        Arrays.asList(supportFrame).forEach(name -> {
            ...
            int line = Integer.parseInt(aopMap.get(name + ".line"));
