...
public class JarUtils {
    ...
    public static String doJar(String jarDir, String targetJar) {
        ...
        try {
            ...
            out = Files.newOutputStream(jar.toPath());
    ...
    public static List<String> unJar(String jarPath, String targetDir, List<String> includeFiles) {
        ...
        try {
            ...
            while (entries.hasMoreElements()) {
                ...
                //跳过未包含的文件
                if (includeFiles != null && !includeFiles.isEmpty() && !includeFiles.contains(targetFile.getName())) {
                    continue;
                }
    ...
    public static String getRootPath(String path) {
        if (path == null) {
            path = Objects.requireNonNull(JarUtils.class.getResource("")).getPath();
        }
