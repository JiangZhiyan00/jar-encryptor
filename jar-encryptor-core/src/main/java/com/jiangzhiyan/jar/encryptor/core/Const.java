...
public class Const {
    ...
    public static void printInfo() {
        ...
        if (sysName.toLowerCase().contains("windows")) {
            ...
            System.out.println("=========================================================");
            System.out.println("=                                                       =");
            System.out.println("=      Java Jar Class Encryptor " + VERSION + "         =");
            System.out.println("=                                                       =");
            System.out.println("=========================================================");
            System.out.println();
            return;
        ...
        System.out.println("\033[35m=       \033[31mJava \033[92mJar \033[95mClass \033[96mEncryptor\033[0m \033[37m"
                + VERSION + "\033[0m   \033[0m     \033[93m=");
