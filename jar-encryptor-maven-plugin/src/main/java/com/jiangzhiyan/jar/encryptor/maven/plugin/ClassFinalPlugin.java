package com.jiangzhiyan.jar.encryptor.maven.plugin;

import com.jiangzhiyan.jar.encryptor.core.Const;
import com.jiangzhiyan.jar.encryptor.core.JarEncryptor;
 ...
 * 加密jar/war文件的maven插件
 */
@Mojo(name = "jarEncryptor", defaultPhase = LifecyclePhase.PACKAGE)
